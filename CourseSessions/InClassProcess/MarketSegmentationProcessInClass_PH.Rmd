...
1. The largest correlations are 0.64 (Q13 and Q14) and 0.63 (Q16 and Q17). Questions 13 and 14 seem to address the same purchasing factors. The other questions are also highly related making the correlations close to 1 reasonable.
2. The correlations obtained imply that the questions asked tend to group people with similar purchasing factors together regardless of the question asked.
...
1. The table presents the Eigenvalue for each variable and the variance explained by each. The eigenvalue tells us the amount of information each variable is giving us relative to the 29 variables being used. For instance, an eigenvalue of 8.43 means that that variable explains 8.43/29 = 29% of the total variance in the data. From these we can find the redundant variables and exclude them.
*
*
*
*
...
1. The following componentes were taken:  
Component 1: reputation / status  
Component 2: hobby / socialization  
Component 3: brand sensitivity  
Component 4: knowledgeability  
Component 5: price sensitivity  

2. Coice of components:  
i) Statsitical: eigenvalue larger than 1  
ii) Interpretation: 
