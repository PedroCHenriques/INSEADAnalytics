...
1. (...)
2. We chose the following questions to describe each factor:
+ Factor 1 (Status): Question 1.9 ("I see my Boat as a status symbol") is the best describer for this factor
+ Factor 2 (Recreation): Question 1.18 ("Boating gives me a feeling of adventure") is the best describer for this factor
+ Factor 3 (Brand): Question 1.4 ("I only consider buying a boat from a reputable brand") is the best describer for this factor
+ Factor 4 (knowledgeability): Question 1.11 ("I tend to perform minor boat repairs and maintenance on my own") is the best describer for this factor
+ Factor 5 (Price sensitivity): Question 1.2 ("When buying a boat, getting the lowest price is more important than the boat brand") is the best describer for this factor
...
We can see the histogram of, say, the first 5 variables:
